...
The working title version of this specification is {{ ngffversion }}.
...
object that MUST contain a `version` key, the value of which MUST be a string specifying the version of the OME-Zarr specification defined by [this document](#ngff-spec-{{ ngffversion }}).
